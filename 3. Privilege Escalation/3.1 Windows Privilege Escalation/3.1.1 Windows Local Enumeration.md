...
`whoami /priv`
[[3.1.2 Windows Privilege Escalation Techniques#Privilege Abuse|Exploitation]]
...
[[3.1.2 Windows Privilege Escalation Techniques#DLL Hijacking|Exploitation]]
...
`Get-ChildItem -Path C:\Users\ -Include *.txt,*.pdf,*.xls,*.xlsx,*.doc,*.docx,*.ini,*.exe,*.bat,*.ps1 -File -Recurse -ErrorAction SilentlyContinue`
...
[[3.1.2 Windows Privilege Escalation Techniques#Service Binary Hijacking|Exploitation]]
...
```
[[3.1.2 Windows Privilege Escalation Techniques#Service Binary Path Exploitation|Exploitation]]
...
Instead of:
`"C:\Program Files\My Program\My service\service.exe"`
[[3.1.2 Windows Privilege Escalation Techniques#Unquoted Service Path Exploitation|Exploitation]]
...
```
[[3.1.2 Windows Privilege Escalation Techniques#Scheduled Task Exploitation|Exploitation]]
...
[[3.1.2 Windows Privilege Escalation Techniques#Windows Registry Service Permissions Exploit|Exploitation]]
...
[[3.1.2 Windows Privilege Escalation Techniques#Autoruns|Exploitation]]
...
[[3.1.2 Windows Privilege Escalation Techniques#AlwaysInstallElevated|Exploitation]]
