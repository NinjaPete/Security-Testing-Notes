...
`sudo -l`
[[3.2.2 Linux Privilege Escalation#Sudo Permissions|Exploit]]
...
`ls -lah /etc/passwd`
[[3.2.2 Linux Privilege Escalation#Writable Passwd|Exploit]]
...
[[3.2.2 Linux Privilege Escalation#Insecure File Permissions|Exploit]]
